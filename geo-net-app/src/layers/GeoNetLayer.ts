...
export default class GeoNetLayer extends CompositeLayer {
    ...
    renderLayers() {
        ...
        const {lineWidthScale, pointRadius, pointOpacity, edgeOpacity, nodeBorderWidth, nodeBorderOpacity} = this.props;
        const layerSettings = {lineWidthScale, pointRadius, pointOpacity, edgeOpacity, nodeBorderWidth, nodeBorderOpacity};
        return [
